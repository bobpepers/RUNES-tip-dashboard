...
const RegisterVerify = (props) => {
    ...
    return (
        <div className="content index600 shadow-w textCenter content">
            ...
            {
                !resend
                    ? <Button variant="contained" color="primary" type="submit" className="btn" size="large" className="resend" onClick={() => resendEmail({ email: email })}>Resend email verification code</Button>
